...
<main>
    <section class="container">
        ...
        <input type="hidden" id="theaCodeCheck" value="N"> <%-- 영화관중복확인 --%>

        <form action="${contextPath}/theainfo/new" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="thea_loc" id="loc">
            <input type="hidden" name="thea_time" id="time">
            <input type="hidden" name="thea_code" id="code">
            <table class="table">
                <tr class="row">
                    <th class="col-md-2">영화관이름</th>
                    <td class="col-md-10">
                        <input type="text" id="theaName" name="thea_name" required minlength="1" maxlength="16" size="16" class="form-control" autocomplete="off">
                    </td>
                </tr>
                <tr class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepicker3" data-target-input="nearest">
                                        <input type="text" id="startTime" class="form-control datetimepicker-input" readonly data-target="#datetimepicker3"/>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <div class="input-group date" id="datetimepicker4" data-target-input="nearest">
                                        <input type="text" id="endTime" class="form-control datetimepicker-input" readonly data-target="#datetimepicker4"/>
                ...
                <tr class="row">
                    ...
                    <td class="col-md-10">
                        <input type="tel" id="theaTel" name="thea_tel" required minlength="1" maxlength="20" size="20" class="form-control" autocomplete="off">
                    </td>
                </tr>
                ...
                <tr class="row">
                    ...
                    <td class="col-md-10">
                        <div class="custom-file">
                            ...
                            <label class="custom-file-label" id="fileName" for="customFile">이미지를 선택해 주세요.</label>
                        </div>

                        <img alt="썸넬" class="d-none mt-3" id="preView" style="max-width: 100%;max-height: 500px">
                    </td>
                </tr>
