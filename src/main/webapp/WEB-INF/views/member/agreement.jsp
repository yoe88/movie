...
<div style="text-align: center">
  ...
  <input type="submit" value="동의" class="btn btn-outline-primary"/> 
  <input type="button" value="취소"  class="btn btn-outline-danger" onclick="javascript:history.back();"/>
  <br>
  <br>
</div>
</form>
