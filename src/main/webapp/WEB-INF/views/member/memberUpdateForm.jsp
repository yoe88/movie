...
<form name="memberUpdateForm" method="post" action="memberupdatepro.do"
	...
	<table class="table" style="text-align: left;">
		...
		<tr>
			...
			<td><input type="text" name="mem_id" id="mem_id" size="15"
				value='${member.mem_id }' readonly></td>
		</tr>
		<tr>
			<th>*비밀번호</th>
		...
		<tr>
			...
			<td><input type="text" name="mem_name" id="mem_name" size="15"
				value='${member.mem_name }' required></td>
		</tr>
		<tr>
			<th>*생년월일</th>
			<td><input type="text" name="mem_birth" id="mem_birth" size="20"
				value='${mem_birth}' placeholder="-없이 숫자만 입력  ex)19990101" required></td>
		</tr>
		<tr>
			<th>*이메일</th>
			<td><input type="text" name="mem_email" id="mem_email" size="30"
				value='${member.mem_email }' readonly> <input type="button"
				class="btn btn-primary btn-sm" value="Email 중복확인"
				onclick="emailCheck()"></td>
		</tr>
		<tr>
			<th>전화번호</th>
			<td><input type="text" name="mem_phone" id="mem_phone" size="15"
		...
		<tr>
			...
			<td><input type="text" name="mem_zipcode" id="mem_zipcode"
				size="7" value='${member.mem_zipcode }' readonly> <input
				type="button" class="btn btn-primary btn-sm" value="주소찾기"
		...
		<tr>
			...
			<td><input type="text" name="mem_addr" id="mem_addr" size="45"
				value='${member.mem_addr }' readonly></td>
		</tr>


		<tr>
			<th>나머지주소</th>
			<td><input type="text" name="mem_addr2" id="mem_addr2"
				value='${member.mem_addr2 }' size="45"></td>
		</tr>

		<tr>
			<td colspan="2" style="text-align: center;"><input type="submit"
				value="회원정보수정" class="btn btn-outline-primary"> <input type="reset"
